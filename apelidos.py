...
for i in range(0, N_TIMES, N_TIMES_POR_ITERACAO):
    try:
        ...
        module_apelidos.apelidos(URL, TIME, par, i, i + N_TIMES_POR_ITERACAO, FILE)
        
# Realiza o processo anterior para os RESTO times que sobraram
try:
    par[TIME[N_TIMES - RESTO]]
except:
    module_apelidos.apelidos(URL, TIME, par, N_TIMES - RESTO, N_TIMES, FILE)